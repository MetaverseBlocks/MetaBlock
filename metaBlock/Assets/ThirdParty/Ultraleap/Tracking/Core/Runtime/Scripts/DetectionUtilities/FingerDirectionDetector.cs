            ...
            while (true)
            {
                if (HandModel != null && HandModel.IsTracked)
                {
                    ...
                    if (hand != null)
                    {
                        ...
                        //Debug.Log("¼Õ°¡¶ô¹æÇâ º¤ÅÍ: "+fingerDirection);
                        //Debug.Log("¼Õ¸ñ º¤ÅÍ:" + hand.WristPosition.ToVector3());

                        //Debug.Log("¼Õ°¡¶ô¹æÇâ º¤ÅÍ: " + targetDirection);

                        /*  if (Physics.Raycast(h, fingerDirection, out hit, 100, UILayer))
                          {
                              Debug.Log("Ãæµ¹µÊ");
                          }*/

                        Ray ray= new Ray(hand.WristPosition.ToVector3(), fingerDirection);
                        Debug.Log(ray);
                        ...
                        {
                            Activate();
                            Debug.Log("finger detector activate ÇÔ¼ö È£ÃâµÊ");
                        }
